			...
			[CustomEditorLabelService.SETTING_ID_PATTERNS]: {
				...
				'markdownDescription': (() => {
					...
					customEditorLabelDescription += '\n- ' + [
						...
						localize('workbench.editor.label.nthfilenamepart', "`${filenamePart(N)}`: the nth part of the filename including the extension separated by '.' (e.g. `N=2: WORKSPACE_FOLDER/folder/file.ext1.ext2.ext3 -> ext1`)."),
